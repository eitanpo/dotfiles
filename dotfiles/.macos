...
# Uncheck 'Close window when quitting an application', or restored windows when re-opening an app
...
defaults write com.apple.menuextra.clock DateFormat "d MMM  H:mm"
...
defaults write NSGlobalDomain NSUseSplitCursor -bool false
...
# To undo `launchctl load -w /System/Library/LaunchAgents/com.apple.rcd.plist`
...
# Sleep the display on charger after 15 minutes
sudo pmset -c displaysleep 15

# Sleep the display on battery after 5 minutes
...
echo ""
read -p "Would you like to kill affected processes, otherwise restart later? (y/n) " -n 1;
	echo ""
	if [[ $REPLY =~ ^[Yy]$ ]]; then
